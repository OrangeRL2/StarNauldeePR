...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // We specify a default translation/size in case there's no data in the .ini file.
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        if (ImGui::BeginPopup("mypicker"))
        {
            ...
            ImGui::BeginGroup(); // Lock X translation
            ImGui::Text("Current");
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        // - Using SetCursorPos() to translation child window (the child window is an item from the POV of parent window)
        //   You can also call SetNextWindowPos() to translation the child window. The parent window will effectively
        //   layout from this translation.
    ...
    if (ImGui::TreeNode("Basic Horizontal Layout"))
    {
        ...
        // Aligned to arbitrary translation. Easy/cheap column.
        ...
        for (int n = 0; n < buttons_count; n++)
        {
            ...
            float next_button_x2 = last_button_x2 + style.ItemSpacing.x + button_sz.x; // Expected translation if next button was on same line
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        for (int line = 0; line < lines; line++)
        {
            ...
            // the cursor translation yourself, aka using SetCursorPos/SetCursorScreenPos to translation the widgets
        ...
        case ImGuiInputTextFlags_CallbackHistory:
            {
                ...
                // A better implementation would preserve the data on the current input line along with cursor translation.
